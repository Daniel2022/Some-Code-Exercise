...
public:
  ...
  //typename std::vector<std::vector<T> *>::iterator get_main() {return mainiterator;}
  //typename std::vector<T>::iterator get_sub() {return subiterator;}
...
/*
template<class T>
typename std::vector<std::vector<T> *>::iterator HyperVectorIterator<T>::get_main() {
  return mainiterator;
}

template<class T>
typename std::vector<T>::iterator HyperVectorIterator<T>::get_sub() {
  return subiterator;
}
*/
template<class T>
...
int main() {
  ...
  HyperVector<float>::iterator itr=vec.begin();
  //itr++;//itr++;
  //itr.mainiterator++;
  //itr.subiterator = (*itr.mainiterator)->end()-1;
  //std::cout << *itr << "\n";
  //if((itr != (itr+100))) {std::cout<<"1"<<"\n";} 
  //std::cout << (itr+1) - itr << "\n";
  //std::cout << *((*(vec.m_data.end()-1))->end()-1) << "\n";
  //for(HyperVector<float>::iterator itr=vec.begin();itr!=vec.end();itr++){
  //  std::cout << "1"<< "\n";
  //  std::cout << *itr << " ";
  //}
